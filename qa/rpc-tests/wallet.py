...
#   c) node1 mines 32 blocks, so now node 0 has 500000ARBI, node 1 has 4250ARBI, node2 has none.
#   d) node0 sends 601 ARBI to node2, in two transactions (301 ARBI, then 300 ARBI).

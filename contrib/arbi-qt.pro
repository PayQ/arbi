...
RESOURCES += src/qt/arbi.qrc src/qt/arbi_locale.qrc

TRANSLATIONS += src/qt/locale/arbi_bg.ts \
                src/qt/locale/arbi_de.ts \
                src/qt/locale/arbi_en.ts \
                src/qt/locale/arbi_es.ts \
                src/qt/locale/arbi_fi.ts \
                src/qt/locale/arbi_fr.ts \
                src/qt/locale/arbi_it.ts \
                src/qt/locale/arbi_ja.ts \
                src/qt/locale/arbi_pl.ts \
                src/qt/locale/arbi_pt.ts \
                src/qt/locale/arbi_ru.ts \
                src/qt/locale/arbi_sk.ts \
                src/qt/locale/arbi_sv.ts \
                src/qt/locale/arbi_vi.ts \
                src/qt/locale/arbi_zh_CN.ts \
                src/qt/locale/arbi_zh_TW.ts

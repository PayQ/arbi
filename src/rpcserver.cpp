...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Arbi features */
        {"arbi", "masternode", &masternode, true, true, false},
        {"arbi", "listmasternodes", &listmasternodes, true, true, false},
        {"arbi", "getmasternodecount", &getmasternodecount, true, true, false},
        {"arbi", "masternodeconnect", &masternodeconnect, true, true, false},
        {"arbi", "masternodecurrent", &masternodecurrent, true, true, false},
        {"arbi", "masternodedebug", &masternodedebug, true, true, false},
        {"arbi", "startmasternode", &startmasternode, true, true, false},
        {"arbi", "createmasternodekey", &createmasternodekey, true, true, false},
        {"arbi", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"arbi", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"arbi", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"arbi", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"arbi", "getmasternodescores", &getmasternodescores, true, true, false},
        {"arbi", "mnbudget", &mnbudget, true, true, false},
        {"arbi", "preparebudget", &preparebudget, true, true, false},
        {"arbi", "submitbudget", &submitbudget, true, true, false},
        {"arbi", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"arbi", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"arbi", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"arbi", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"arbi", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"arbi", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"arbi", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"arbi", "checkbudgets", &checkbudgets, true, true, false},
        {"arbi", "mnsync", &mnsync, true, true, false},
        {"arbi", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> arbi-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:38862/\n";
}

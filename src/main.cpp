...
#if defined(NDEBUG)
#error "Arbi cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in uarbi) are considered zero fee (for relaying and mining)
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight == 0) {
        ...
        nSubsidy = 3750 * COIN; // Premine
    } else if (nHeight >= 401 && nHeight <= 6161) {
        nSubsidy = 0.1 * COIN; // Launch phase
    } else if (nHeight >= 6162 && nHeight <= 9042) {
        nSubsidy = 0.2 * COIN;
    } else if (nHeight >= 9043 && nHeight <= 11923) {
        nSubsidy = 0.3 * COIN;
    } else if (nHeight >= 11924 && nHeight <= 14804) {
        nSubsidy = 0.4 * COIN;
    } else if (nHeight >= 14805 && nHeight <= 17685) {
        nSubsidy = 0.5 * COIN;
    } else if (nHeight >= 17686 && nHeight <= 20566) {
        nSubsidy = 0.6 * COIN;
    } else if (nHeight >= 20567 && nHeight <= 23447) {
        nSubsidy = 0.7 * COIN;
    } else if (nHeight >= 23448 && nHeight <= 26328) {
        nSubsidy = 0.85 * COIN;
    } else if (nHeight >= 26329 && nHeight <= 29209) {
        nSubsidy = 1 * COIN;
    } else if (nHeight >= 29210 && nHeight <= 32090) {
        nSubsidy = 0.9 * COIN;
    } else if (nHeight >= 32091 && nHeight <= 34971) {
        nSubsidy = 0.8 * COIN;
    } else if (nHeight >= 34972 && nHeight <= 37852) {
        nSubsidy = 0.7 * COIN;
    } else if (nHeight >= 37853 && nHeight <= 40733) {
        nSubsidy = 0.6 * COIN;
    } else if (nHeight >= 40734) {
        nSubsidy = 0.5 * COIN;
    } else {
        nSubsidy = 0 * COIN;
    }
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // ARBI: We use certain sporks during IBD, so check to see if they are

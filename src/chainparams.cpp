...
// Copyright (c) 2017 The Arbi developers
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000b9d8322d0c456f2ec6e068be49b554df10ef656fefc7d2af97abaf7e4c2"))
    (1000, uint256("0x699754165a2dfa1a813340b7596dc0437367bcaa962ee81e997a281703e65536"));

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1542881871, // * UNIX timestamp of last checkpoint block
    1604,          // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Arbi: 1 day
        nTargetSpacing = 2 * 60;  // Arbi: 2 minutes
        nMaturity = 10;
        ...
        nLastPOWBlock = 400;
        nModifierUpdateBlock = 1; // we use the version 2 for ARBI

        const char* pszTimestamp = "21 Nov 2018 is 325th day of the year";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1542758400;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 1496732;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000b9d8322d0c456f2ec6e068be49b554df10ef656fefc7d2af97abaf7e4c2"));
        assert(genesis.hashMerkleRoot == uint256("0xf67e6e034d1a8d6016c5a4eb6ba6341a6b319523753f9758151b1012001889f3"));

        // DNS Seeding
        vSeeds.push_back(CDNSSeedData("arbi.cc", "dnsseed1.arbi.cc"));
        vSeeds.push_back(CDNSSeedData("arbi.cc", "dnsseed2.arbi.cc"));
        vSeeds.push_back(CDNSSeedData("95.213.204.56", "95.213.204.56"));
        vSeeds.push_back(CDNSSeedData("5.189.224.66", "5.189.224.66"));
        vSeeds.push_back(CDNSSeedData("82.202.204.173", "82.202.204.173"));

        // Arbi addresses start with 'A'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 23);
        // Arbi script addresses start with '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 20);
        // Arbi private keys start with '9' or 'A'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 22);
        // Arbi BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // Arbi BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
        // Arbi BIP44 coin type is '477' (0x800001dd)
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Arbi: 1 day
        nTargetSpacing = 2 * 60;  // Arbi: 1 minute
        nLastPOWBlock = 400;
        nMaturity = 15;
        ...
        // Testnet Arbi addresses start with 'n'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 112);
        // Testnet Arbi script addresses start with '5'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 10);
        // Testnet private keys start with '5' or 'n' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 240);
        // Testnet Arbi BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet Arbi BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
        // Testnet arbi BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Arbi: 1 day
        nTargetSpacing = 2 * 60;        // Arbi: 1 minutes
        bnProofOfWorkLimit = ~uint256(0) >> 1;

                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Arbi Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ARBI address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and arbi: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Arbi Core"), this);
    aboutAction->setStatusTip(tr("Show information about Arbi Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Arbi"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ARBI addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ARBI addresses"));
    ...
    openAction->setStatusTip(tr("Open a arbi: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Arbi Core help message to get a list with possible Arbi command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Arbi Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Arbi network", "", count));
}
...
{
    QString strTitle = tr("Arbi Core"); // default title

...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Arbi Core arbi-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  arbi-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded arbi transaction") + "\n" +
                               "  arbi-tx [options] -create [commands]   " + _("Create hex-encoded arbi transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded arbi transaction

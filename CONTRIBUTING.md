Contributing to Arbi Core
==================================

The Arbi Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Arbi Core project, and is not to be
confused with overall Arbi Network Protocol consensus changes.

Whether a pull request is merged into Arbi Core rests with the project merge
...
Patches that change Arbi consensus rules are considerably more involved than
...
Where a patch set proposes to change the Arbi consensus, it must have been
...
The project leader is the release manager for each Arbi Core release.

...
This mechanism has been integrated into Bitcore-Node-Arbi which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/arbi/insight-api-arbi#web-socket-api](https://github.com/arbi/insight-api-arbi#web-socket-api)
* API: [https://github.com/arbi/insight-api-arbi#swifttx-transactions](https://github.com/arbi/insight-api-arbi#swifttx-transactions)
...
By default, the Arbi Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Arbi Core daemon:

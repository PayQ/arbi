...
In order to support loading of multiple wallets in arbi-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is arbi.cpp.
...
Changes to arbi.cpp
----------------------
arbi.cpp is the entry point into arbi-qt, and as such, will require some minor modifications to provide hooks for
